                   ...
                   (case op
                     ...
                     (:iff
                      (destructuring-bind (a b) args
                        ;; TODO: handle this case
                        (if truth
                            (list 'and (visit (list ':implies a b) truth) (visit (list ':implies b a) truth))
                            (list 'or (visit (list ':implies a b) truth) (visit (list ':implies b a) truth))
                        )))
                     (not
                     ...
                     (and
                      ...
                      (if truth
                          ...
                          (let* ((orl '()))
                            (dolist (a args orl)
                              (setq orl (cons (visit a truth) orl)))
                            (setq orl (cons 'or orl))
                            orl)
                      ))
                     (or
                      ;; TODO: handle this case
